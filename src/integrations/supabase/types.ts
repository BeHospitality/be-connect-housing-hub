  ...
  public: {
    Tables: {
      ...
      complexes: {
        ...
        Relationships: [
          {
            foreignKeyName: "complexes_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      message_channels: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_channels_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      roommate_pairings: {
        ...
        Relationships: [
          {
            foreignKeyName: "roommate_pairings_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      security_deposit_statements: {
        ...
        Relationships: [
          {
            foreignKeyName: "security_deposit_statements_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      vendor_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_assignments_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
